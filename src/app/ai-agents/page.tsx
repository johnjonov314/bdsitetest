    ...
    <Container>
      ...
      <div className="space-y-8 py-12">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {[
            { title: "Доверие и качество", text: "Проверка источников, контроль сценариев, SLA и мониторинг качества ответов." },
            { title: "Что мы не делаем", text: "Не подменяем юридическую и финансовую ответственность клиента: финальное решение принимает команда." },
