...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = ["", "/platform", "/solutions", "/ai-agents", "/industries", "/cases", "/insights", "/about", "/contacts", "/playbook", "/design-system", "/docs/overview", "/docs/design-system", "/docs/motion-grammar", "/docs/content-playbook", "/docs/components", "/docs/architecture", "/docs/qa-release", "/docs/deck"].map((path) => ({
